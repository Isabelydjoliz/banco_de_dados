...
INSERT INTO `aluguel` (`IDaluguel`, `datafim`, `datainicio`, `tipocontrato`, `datavencimento`, `descri`, `IDinquilino`, `IDimovel`, `IDcorretor`, `valor`) VALUES
(1, '2027-08-18', '2022-08-18', '--', '15', '--', 1, 1, 1, 3510.0000),
(2, '2025-11-01', '2020-11-01', '--', '05', '--', 2, 2, 2, 1755.0000),
(3, '2026-05-24', '2022-05-24', '--', '01', '--', 3, 3, 3, 1755.0000),
(4, '2025-01-09', '2020-01-09', '--', '05', '--', 4, 4, 4, 1404.0000),
(5, '2028-03-19', '2018-03-19', '--', '25', '--', 5, 5, 5, 1415.6883),
(6, '2028-10-16', '2018-10-16', '--', '25', '--', 6, 6, 6, 3276.0000),
(7, '2027-03-16', '2017-03-16', '--', '05', '--', 7, 7, 7, 5265.0000),
(8, '2024-12-20', '2019-12-20', '--', '01', '--', 8, 8, 8, 2233.5300),
(9, '2029-05-23', '2024-05-23', '--', '10', '--\r\n', 9, 9, 9, 1872.0000),
(10, '2028-07-10', '2023-07-10', '--', '01', '--', 10, 10, 10, 1989.0000);
...
INSERT INTO `imovel` (`IDimovel`, `bairro`, `estado`, `cidade`, `rua`, `complemento`, `areatotal`, `pais`, `suite`, `garagem`, `numerocasa`, `alugado`, `banheiro`, `quarto`, `vagasgaragem`, `quintal`, `lavanderia`, `piscina`, `areaconstruida`, `IDproprietario`, `qtdcomodos`, `valor`) VALUES
(1, 'Jardim Maristela', 'São Paulo', 'Ribeirão Pires', 'Ernesto Alves', 'sem complemento', 198.00, 'Brasil', 1, b'1', '476', b'1', 2, 2, 1, b'1', b'1', b'0', 150.00, 1, 5, 3510.00),
(2, 'Imperatriz', 'São Paulo', 'Jundiaí', 'Rua estrada do ferrador', 'sem complemento', 300.00, 'Brasil', 3, b'1', '49', b'1', 5, 2, 3, b'1', b'1', b'1', 250.00, 2, 11, 1755.00),
(3, 'Jardins', 'São Paulo', 'São Paulo', 'Limoeiro', 'sem complemento', 235.00, 'Brasil', 2, b'1', '54', b'1', 4, 2, 2, b'1', b'1', b'1', 198.00, 3, 7, 1755.00),
(4, 'Mirante Verde', 'São Paulo', 'São Paulo', 'Augusta', 'Quinto andar, apartamento com área externa', 112.00, 'Brasil', 2, b'1', '52', b'1', 3, 1, 1, b'0', b'1', b'0', 105.00, 4, 6, 1404.00),
(5, 'Vila Nova', 'São Paulo', 'São Paulo', 'Aurora Boreal', 'sem complemento', 150.00, 'Brasil', 1, b'1', '24', b'1', 3, 2, 2, b'1', b'1', b'1', 118.00, 5, 6, 1415.69),
(6, 'Capim Dorado', 'São Paulo', 'Várzea Paulista', 'Esmeralda', 'sem complemento', 200.00, 'Brasil', 2, b'1', '536', b'1', 4, 2, 3, b'1', b'1', b'1', 167.00, 6, 5, 3276.00),
(7, 'Riacho Fundo', 'São Paulo', 'Socrro', 'Nitorial', 'sem complemento', 523.00, 'Brasil', 4, b'1', '976', b'1', 6, 2, 4, b'1', b'1', b'1', 586.00, 7, 7, 5265.00),
(8, 'Mato Verde', 'São Paulo', 'Moca', 'Vento Limpo', 'sem complemento', 77.00, 'Brasil', 1, b'1', '12', b'1', 2, 1, 1, b'0', b'1', b'0', 77.00, 8, 5, 2233.53),
(9, 'Rio Claro', 'São Paulo', 'Bauru', 'Estrada do campo', 'sem complemento', 84.00, 'Brasil', 2, b'1', '85', b'1', 3, 1, 1, b'1', b'1', b'0', 74.00, 9, 5, 1872.00),
(10, 'Vinhedo', 'São Paulo', 'França', 'Itália', 'sem complemento', 123.00, 'Brasil', 2, b'1', '78', b'1', 3, 1, 2, b'1', b'1', b'1', 99.00, 10, 7, 1989.00),
(11, 'bairro feliz', 'São Paulo', 'São Paulo', 'Esmeralda verde', 'sem complemento', 112.00, 'Brasil', 1, b'1', '335', b'0', 3, 2, 1, b'1', b'1', b'1', 97.00, 7, 6, 3510.00),
(12, 'Riacho Fundo', 'São Paulo', 'Campinas', 'Lanjanjeira', 'sem complemento', 150.00, 'Brasil', 2, b'1', '20', b'0', 2, 2, 1, b'1', b'1', b'1', 122.00, 6, 6, 3276.00);
...
--
ALTER TABLE `imovel`
  MODIFY `IDimovel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
